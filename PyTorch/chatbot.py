...
# apply function is from pandas Dataframe
# It will apply fuction to every column and return dataframe
...
print(len(pairs))
print(random.choice(pairs)) #Take any random choice from Input-Target pairs
print(VOC.n_words)

######################################## PYTORCH UTILS.
print("data ready, Lets go for pytorch")

def lr_decay(optimizer):
    """Decay learning rate by a factor of lr_decay"""
    """ Optimizer.param_groups return dictonary of param attached to the optimizer"""
...
def indexes_from_sentence(sentence):
    ...
    # vec --> vector of index which represents the words in sentences
    # total length of vec is 10
    # all tokens are <EOS> after the finishing of sentence 
    return vec, length
